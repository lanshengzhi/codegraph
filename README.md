...
codegraph status --coverage       # Detailed coverage report (pending changes, errors, unresolved refs, workspace/alias summaries)
codegraph status --check-filesystem  # Also scan filesystem for missing/removed source files (implies --coverage)
